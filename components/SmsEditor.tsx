...
type SmsEditorProps = {
    ...
    enabledLangs: string[];
    smsContents: Record<string, string>;
...
const SmsEditor: React.FC<SmsEditorProps> = ({
    ...
    const updateBody = (value: string) => {
        setSmsContents((prev) => ({ ...prev, [activeLang]: value }));
        ...
        <section className="bg-white rounded-xl shadow p-6 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] text-slate-500">
                    * 단말 미리보기로 작성 중인 내용을 실시간 확인할 수 있습니다.
                </span>
            </div>
                ...
                <div className="flex justify-center">
                    <div className="w-[260px] h-[520px] bg-slate-100 rounded-[32px] shadow-inner p-3 border border-slate-200 flex flex-col">
                        ...
                        <div className="mt-2 bg-white rounded-2xl shadow-sm p-3 flex-1">
                            <div className="w-full h-full rounded-2xl bg-slate-50 border border-slate-200 p-3 text-[11px] leading-snug text-slate-800 overflow-y-auto whitespace-pre-line">
