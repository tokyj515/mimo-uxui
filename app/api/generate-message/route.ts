...
5) 4대 검토사항 추천(recommendedCheckTypes):
   ...
   - 절대 ["법률"] 한 가지만 반복적으로 넣지 마세요.
   - 원칙:
     * 기본적으로 최소 2개 이상을 선택합니다.
     * 광고/이벤트/프로모션( sendPurpose = "이벤트" 또는 adType = "광고" ) →
       ["법률","공정경쟁"] 또는 ["법률","공정경쟁","리스크"]
     * 개인정보·보안·사기주의 안내( 피싱/스미싱/개인정보 유출 등 키워드 ) →
       ["법률","정보보호"] 또는 ["법률","정보보호","리스크"]
     * 서비스 장애/품질/요금 변동/일반 공지 →
       ["법률","리스크"] 또는 ["법률","리스크","정보보호"]
   - 메시지 내용을 읽고 가장 잘 맞는 조합을 골라서,
     배열 순서는 중요도 높은 항목부터 나열합니다.
...
특히 recommendedCheckTypes는 메시지 성격에 맞게 2개 이상을 다양하게 선택하세요.
    `.trim();
